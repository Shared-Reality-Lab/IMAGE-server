...
#the parameters in run were generated by the author of the code. 
...
def run(weights='yolov5s.pt',  
    ...
    if request.method == 'POST':
        ...
        for path, img, im0s, vid_cap in dataset:
            ...
            #once the predictions are generated convert the image to original size. 
            ...
            #create a json output and validate the json
                    for *xyxy, conf, cls in reversed(det):
                        if save_img or save_crop or view_img:
                            ...
                            dictionary = {
                                "ID": i, "type": str(label[:-4]), "dimensions": [xleft,yleft,xright,yright],
